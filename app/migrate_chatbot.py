"""
Migración que asegura que las tablas de Chatbot (chatbot_configs)
...
def migrate():
    print("Iniciando migración de tablas para el módulo Chatbot...")
    try:
        ...
        print("✅ Tablas de Chatbot creadas exitosamente.")
