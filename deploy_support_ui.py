...
files = [
    ("app/templates/support/create_ticket.html", REMOTE_DIR + "/app/templates/support/create_ticket.html"),
...
# Templates might be read on each request, but let's restart just in case.
