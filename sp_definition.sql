                ...
                LEFT JOIN ( SELECT
                            ...
                            FROM
                                ...
                                INNER JOIN ( SELECT
                                             ...
                                             GROUP BY
                                                DEVR.doc_num, DEVR.co_alma, DEVR.co_art, DEVR.reng_num, SE.numero_lote
                                           ) AS DEVR ON DVR.doc_num = DEVR.doc_num
                                                        AND DVR.co_alma = DEVR.co_alma
                                                        AND DVR.co_art = DEVR.co_art
                                                        AND DVR.reng_num = DEVR.reng_num
...
--- Fin Sit.#44212 -12
                                             GROUP BY
                                                DEVR.tras_num, T.alm_tmp, DEVR.co_art, DEVR.reng_num, SE.numero_lote
                                           ) AS DEVR ON DVR.tras_num = DEVR.tras_num
                                                        AND tr.alm_tmp = DEVR.alm_tmp
                                                        AND DVR.co_art = DEVR.co_art
                                                        AND DVR.reng_num = DEVR.reng_num
